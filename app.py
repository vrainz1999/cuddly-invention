...
class Pendaftaran(db.Model):
    ...
    #dokter_id = db.Column(db.Integer, db.ForeignKey('dokter.id')) #tambahan
    ...
    def __init__(self, nama, tl, tg_lahir, jk, status, profesi, alamat, keterangan):
        ...
        #self.dokter_id = dokter_id #tambahan
...
def pendaftaran():
    ...
    print(data)  # Debugging: cetak data ke konsol
...
def editdokter(id):
    ...
    if request.method == 'POST':
        ...
        db.session.commit()
        return redirect(url_for('dokter'))  # Redirect to the dokter page or any other page
